# Copilot Instructions — `ai-microservice`
...
- **Authoritative path**: `/home/ssf/Documents/Github/ai-microservice` on the `alfares` server.
- **Origin**: `git@github.com:speakASAP/ai-microservice.git`, branch `main`.
